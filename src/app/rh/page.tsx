...
import { BriefcaseBusiness, CalendarDays, CircleDollarSign, Mail, MapPin, Phone, Plus, Search, UserCheck, UserRound, UsersRound } from "lucide-react";
...
export default function RhPage() {
  ...
  useEffect(() => {
    ...
    return () => { unsubscribe(); window.removeEventListener("open-employee-form", open); };
  }, []);
