...
export const DEFINITIONS: Record<string, Definition> = {
  ...
  cashClosings: {
    ...
    fields: [
      f("date", "Data", "date"),
      opt("shift", "Turno", ["Almoço", "Jantar", "Dia inteiro"]),
      f("operatorName", "Operador responsável"),
      f("openingAmount", "Fundo inicial (R$)", "money"),
      f("cashSales", "Vendas em dinheiro (R$)", "money"),
      f("pixSales", "Vendas em PIX (R$)", "money"),
      f("cardSales", "Vendas em cartão (R$)", "money"),
      f("withdrawals", "Sangrias e retiradas (R$)", "money"),
      f("countedCash", "Dinheiro contado (R$)", "money"),
  ...
  cashConferences: {
    ...
    fields: [
      ...
      f("systemTotal", "Total no sistema (R$)", "money"),
      f("reportedTotal", "Total informado (R$)", "money"),
      f("difference", "Diferença apurada (R$)", "money"),
      opt("status", "Situação", ["Pendente", "Conferido", "Com divergência"]),
