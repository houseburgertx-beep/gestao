...
import { Shield, LogOut, UserPlus, Key, Mail, Check, AlertCircle } from "lucide-react";
...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  const { user, userProfile, login, logout, registerUser, resetPassword } = useAuth();
        ...
        <div className="space-y-4">
          ...
          {tab === "register" && (
            <form onSubmit={handleRegister} className="space-y-3">
              <div>
                <label className="block text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1">Nome Completo</label>
                <input
                  type="text"
                  required
                  value={name}
              ...
              <div>
                <label className="block text-xs font-medium text-zinc-700 dark:text-zinc-300 mb-1">Senha</label>
                <input
                  type="password"
                  required
                  value={password}
